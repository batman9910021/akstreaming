...
async def start(client, message):
    buttons = [
            ...
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/akimaxmoviese"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/akimax2"),
            ],
            [
                InlineKeyboardButton("MORE BOTS", url="https://t.me/akimaxmovies"),
                InlineKeyboardButton("SOURCE CODE", url="https://t.me/akimaxmovies"),
            ],
            [
...
async def show_help(client, message):
    buttons = [
            ...
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/akimaxmovies"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/akimax2"),
            ],
            [
                InlineKeyboardButton("MORE BOTS", url="https://t.me/akimaxmovies"),
